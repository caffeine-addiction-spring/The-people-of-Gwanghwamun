...
public class PaymentController {
    ...
    public ResponseEntity<ApiResponse<PaymentResDTO>> createPayment(
        ...
        PaymentResDTO paymentResDTO = paymentService.createPayment(orderId, paymentCreateReqDTO, userDetails.getUser().getUserId());
    ...
    public ResponseEntity<ApiResponse<PaymentResDTO>> findPayment(
        ...
        PaymentResDTO paymentResDTO = paymentService.findPaymentById(paymentId, userDetails.getUser().getUserId());
    ...
    public ResponseEntity<ApiResponse<Page<PaymentResDTO>>> getPaymentList(
        ...
        return ResponseUtil.successResponse(SuccessCode.PAYMENT_LIST_FIND_SUCESS, paymentList);
    }
    ...
    public ResponseEntity<ApiResponse<Page<PaymentDetailResDTO>>> getPaymentListByStore(
        ...
        Page<PaymentDetailResDTO> storePaymentList = paymentService.findPaymentListByStoreId(storeId, userDetails.getUser().getUserId(), pageable);
        return ResponseUtil.successResponse(SuccessCode.PAYMENT_STORE_LIST_FIND_SUCESS, storePaymentList);
    }
