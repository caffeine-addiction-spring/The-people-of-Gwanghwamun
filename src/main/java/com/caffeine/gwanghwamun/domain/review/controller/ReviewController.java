...
import com.caffeine.gwanghwamun.domain.review.dto.ReviewListResDTO;
...
public class ReviewController {
    ...
    public ResponseEntity<ApiResponse<ReviewResDTO>> createReview(
        ...
        ReviewResDTO reviewResDTO = reviewService.saveReview(orderId, reviewCreateReqDTO, userDetails.getUser().getUserId());
    ...
    public ResponseEntity<ApiResponse<UUID>> createReply(
        ...
        UUID reviewReplyId = reviewService.createReply(reviewId, reviewReplyCreateReqDTO, userDetails.getUser().getUserId());
