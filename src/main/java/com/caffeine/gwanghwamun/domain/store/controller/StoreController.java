...
public class StoreController {
	...
	@Operation(summary = "가게 등록 API", description = "가게를 등록한다.")
	...
	@Operation(summary = "가게 수정 API", description = "가게 정보를 수정한다.")
	@PreAuthorize("hasAnyRole('OWNER', 'MANAGER', 'MASTER')")
	@PutMapping("/{storeId}")
	...
	@Operation(summary = "가게 삭제 API", description = "가게를 삭제한다.")
	@PreAuthorize("hasAnyRole('OWNER', 'MANAGER', 'MASTER')")
	...
	@Operation(summary = "가게 검색 API", description = "키워드로 가게를 검색한다.")
	@GetMapping("/search")
