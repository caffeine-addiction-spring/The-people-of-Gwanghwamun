...
public class PaymentService {
    ...
    @Transactional
    public PaymentResDTO createPayment(UUID orderId, @Valid PaymentCreateReqDTO paymentCreateReqDTO, Long userId) {
    ...
    @Transactional(readOnly = true)
    public Page<PaymentDetailResDTO> findPaymentListByStoreId(UUID storeId, Long userId, Pageable pageable) {
